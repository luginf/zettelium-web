...
const I18n = (() => {
  const STRINGS = {
    fr: {
      ...
      'browser.addFavorite': 'Ajouter aux favoris',
      'browser.removeFavorite': 'Retirer des favoris',
      'browser.favoriteIndicator': 'Favori',
      ...
      'repo.colorTooltip': 'Couleur du dépôt',
      'repo.colorDialogTitle': 'Couleur du dépôt',
      'repo.colorNone': 'Aucune couleur',
      'repo.colorCustom': 'Couleur personnalisée…',
      'repo.colorCustomConfirm': 'Valider la couleur personnalisée',
      'repo.colorCustomPickTooltip': 'Choisir une couleur personnalisée',
      ...
      'browser.repairingLabel': 'Réparation en cours…',
      'browser.refreshTooltip': 'Rafraîchir la liste',
      'browser.resizeSidebarTooltip': 'Glisser pour redimensionner le panneau',
      ...
      'browser.searchScopeRepoTooltip': 'Recherche limitée à ce dépôt (cliquer pour chercher dans tous les dépôts)',
      'browser.searchScopeAllTooltip': 'Recherche dans tous les dépôts (cliquer pour limiter à ce dépôt)',
      'browser.clearSearchTooltip': 'Effacer la recherche',
      ...
      'browser.duplicateAlreadyExists': '"{name}" existe déjà dans ce dossier.',
      'browser.duplicateFailed': 'Échec de la duplication : {error}',
      ...
      'editor.distractionFree': 'Mode sans distraction',
      'editor.distractionFreeExitTooltip': 'Quitter le mode sans distraction (Échap)',
      ...
      'editor.goToId': 'Aller à l\'ID Zettelkasten',
      'editor.goToIdNotInBody': 'L\'ID de cette note vient du nom de fichier, pas du corps du texte.',
      'editor.goToIdNone': 'Aucun ID Zettelkasten dans cette note.',
      'editor.ctxFollowLink': 'Suivre le lien',
      'editor.ctxLinkNotFound': 'Aucune note avec l\'ID {zkId}.',
      'editor.ctxH1': 'Titre 1',
      'editor.ctxH2': 'Titre 2',
      'editor.ctxH3': 'Titre 3',
      'editor.ctxBold': 'Gras',
      'editor.ctxItalic': 'Italique',
      'editor.ctxUnderline': 'Souligné',
      'editor.ctxStrike': 'Barré',
      'editor.ctxComment': 'Commentaire',
      'editor.ctxList': 'Liste',
      'editor.ctxCheckbox': 'Case à cocher',
      'editor.ctxIndent': 'Indenter',
      'editor.ctxDedent': 'Désindenter',
      'editor.ctxDate': 'Date',
      'editor.ctxEval': 'Évaluer',
      'editor.ctxEvalFailed': 'Échec de l\'évaluation : {error}',
      ...
      'editor.emptyStateHint': 'Choisis une note dans la liste pour l\'ouvrir.',
      ...
      'editor.search': 'Rechercher dans la note',
      'editor.searchPlaceholder': 'Rechercher…',
      'editor.searchMatchCount': '{count} correspondance(s)',
      'editor.searchPrevTooltip': 'Correspondance précédente',
      'editor.searchNextTooltip': 'Correspondance suivante',
      'editor.encryptedIndicatorTooltip': 'Cette note est chiffrée',
      'editor.encryptedPasswordTitle': 'Note chiffrée',
      'editor.encryptedPasswordText': 'Cette note est chiffrée. Entrez le mot de passe pour l\'ouvrir.',
      'editor.encryptedPasswordError': 'Mot de passe incorrect.',
      'editor.encryptedUnlockAction': 'Déverrouiller',
      'editor.encryptNoteTitle': 'Chiffrer la note',
      'editor.encryptNoteText': 'Le corps de la note sera chiffré (compatible QOwnNotes). Sans ce mot de passe, la note ne sera plus lisible - ne le perdez pas.',
      'editor.encryptNoteConfirm': 'Chiffrer',
      'editor.decryptNoteTitle': 'Déchiffrer la note',
      'editor.decryptNoteText': 'La note sera enregistrée en clair - elle ne sera plus chiffrée sur le disque.',
      'editor.decryptNoteConfirm': 'Déchiffrer',
      'editor.passwordPlaceholder': 'Mot de passe',
      'editor.passwordConfirmPlaceholder': 'Confirmer le mot de passe',
      'editor.passwordMismatch': 'Les mots de passe ne correspondent pas.',
      'editor.passwordHideToggle': 'Masquer le mot de passe',
      ...
      'settings.fileListSidebarLabel': 'Liste des fichiers épinglée',
      'settings.fileListSidebarDesc': 'À l\'ouverture d\'une note, garde la liste des fichiers visible dans un panneau à gauche de l\'éditeur, pour naviguer rapidement entre les notes.',
      'settings.headingSizesLabel': 'Titres agrandis dans l\'éditeur',
      'settings.headingSizesDesc': 'Désactiver si le curseur ou la sélection semblent décalés sur une note à plusieurs titres — garde la couleur des titres, retire seulement l\'agrandissement.',
      'settings.distractionFreeMarginFactorLabel': 'Marges en mode sans distraction',
      'settings.distractionFreeMarginFactorDesc': 'Facteur de grossissement des marges de l\'éditeur pendant que le mode sans distraction est actif (1 = normal, 2 = double, 3 = triple...).',
      'settings.sectionPreview': 'Aperçu',
      'settings.previewCssDesc': 'CSS appliqué au rendu de l\'aperçu d\'une note — modifiable librement, enregistré dans ce navigateur.',
      'settings.previewCssReset': 'Réinitialiser au CSS par défaut',
    },
    en: {
      'common.back': 'Back',
      ...
      'browser.favoriteIndicator': 'Favorite',
      'common.save': 'Save',
      ...
      'repo.colorTooltip': 'Repository color',
      'repo.colorDialogTitle': 'Repository color',
      'repo.colorNone': 'No color',
      'repo.colorCustom': 'Custom color…',
      'repo.colorCustomConfirm': 'Confirm custom color',
      'repo.colorCustomPickTooltip': 'Choose a custom color',
      ...
      'browser.repairingLabel': 'Repairing…',
      'browser.refreshTooltip': 'Refresh the list',
      'browser.resizeSidebarTooltip': 'Drag to resize the panel',
      ...
      'browser.searchScopeRepoTooltip': 'Search limited to this repository (click to search all repositories)',
      'browser.searchScopeAllTooltip': 'Searching all repositories (click to limit to this repository)',
      'browser.clearSearchTooltip': 'Clear search',
      ...
      'browser.duplicateAlreadyExists': '"{name}" already exists in this folder.',
      'browser.duplicateFailed': 'Duplication failed: {error}',
      ...
      'editor.distractionFree': 'Distraction-free mode',
      'editor.distractionFreeExitTooltip': 'Exit distraction-free mode (Esc)',
      ...
      'editor.goToId': 'Go to Zettelkasten ID',
      'editor.goToIdNotInBody': 'This note\'s ID comes from the file name, not the body text.',
      'editor.goToIdNone': 'No Zettelkasten ID in this note.',
      'editor.ctxFollowLink': 'Follow link',
      'editor.ctxLinkNotFound': 'No note with ID {zkId}.',
      'editor.ctxH1': 'Heading 1',
      'editor.ctxH2': 'Heading 2',
      'editor.ctxH3': 'Heading 3',
      'editor.ctxBold': 'Bold',
      'editor.ctxItalic': 'Italic',
      'editor.ctxUnderline': 'Underline',
      'editor.ctxStrike': 'Strikethrough',
      'editor.ctxComment': 'Comment',
      'editor.ctxList': 'List',
      'editor.ctxCheckbox': 'Checkbox',
      'editor.ctxIndent': 'Indent',
      'editor.ctxDedent': 'Outdent',
      'editor.ctxDate': 'Date',
      'editor.ctxEval': 'Evaluate',
      'editor.ctxEvalFailed': 'Evaluation failed: {error}',
      ...
      'editor.emptyStateHint': 'Pick a note from the list to open it.',
      ...
      'editor.search': 'Find in note',
      'editor.searchPlaceholder': 'Find…',
      'editor.searchMatchCount': '{count} match(es)',
      'editor.searchPrevTooltip': 'Previous match',
      'editor.searchNextTooltip': 'Next match',
      'editor.encryptedIndicatorTooltip': 'This note is encrypted',
      'editor.encryptedPasswordTitle': 'Encrypted note',
      'editor.encryptedPasswordText': 'This note is encrypted. Enter the password to open it.',
      'editor.encryptedPasswordError': 'Wrong password.',
      'editor.encryptedUnlockAction': 'Unlock',
      'editor.encryptNoteTitle': 'Encrypt note',
      'editor.encryptNoteText': 'The note\'s body will be encrypted (QOwnNotes-compatible). Without this password, the note won\'t be readable anymore - don\'t lose it.',
      'editor.encryptNoteConfirm': 'Encrypt',
      'editor.decryptNoteTitle': 'Decrypt note',
      'editor.decryptNoteText': 'The note will be saved in plain text - it won\'t be encrypted on disk anymore.',
      'editor.decryptNoteConfirm': 'Decrypt',
      'editor.passwordPlaceholder': 'Password',
      'editor.passwordConfirmPlaceholder': 'Confirm password',
      'editor.passwordMismatch': 'Passwords don\'t match.',
      'editor.passwordHideToggle': 'Hide password',
      ...
      'settings.fileListSidebarLabel': 'Pinned file list',
      'settings.fileListSidebarDesc': 'When you open a note, keeps the file list visible in a panel to the left of the editor, for quick navigation between notes.',
      'settings.headingSizesLabel': 'Enlarged headings in the editor',
      'settings.headingSizesDesc': 'Turn off if the cursor or selection look offset on a note with several headings — keeps heading color, only removes the size increase.',
      'settings.distractionFreeMarginFactorLabel': 'Distraction-free margins',
      'settings.distractionFreeMarginFactorDesc': 'Magnification factor for the editor\'s margins while distraction-free mode is active (1 = normal, 2 = double, 3 = triple...).',
      'settings.sectionPreview': 'Preview',
      'settings.previewCssDesc': 'CSS applied to a note\'s rendered preview — freely editable, stored in this browser.',
      'settings.previewCssReset': 'Reset to default CSS',
    },
  };
